...
const Result = () => {
	return (
		<section className="h-screen py-12 bg-black">
			<div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
				<div className="max-w-4xl p-8 mx-auto bg-white rounded-lg shadow-lg">
					...
					<div className="flex justify-center">
						<Link
							to="/"
							className="px-6 py-3 font-bold text-white bg-gray-400 rounded-lg shadow-lg z-30 hover:text-white relative font-sans after:-z-20 after:absolute after:h-1 after:w-1 after:bg-gray-600 after:left-5 overflow-hidden after:bottom-0 after:translate-y-full after:rounded-md after:hover:scale-[300] after:hover:transition-all after:hover:duration-700 after:transition-all after:duration-700 transition-all duration-700 text-xl"
						>
							Back to Home
						</Link>
					</div>
